...
\begin{itemize}
    ...
    \item \textbf{Casos Medianos ($n \in \{20, 40, 80\}$):} Orientados a medir la brecha de calidad entre las heurísticas Greedy y la solución óptima de DP. De igual manera, para demostrar que fuerza bruta es poco viable, se ejecutó para instancias de $n=20$ y $n=40$ únicamente.
