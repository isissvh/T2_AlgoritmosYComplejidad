...
La ejecución de los algoritmos y la generación de métricas se ha automatizado mediante un `makefile`. Para correr el proyecto de manera simple:
...
make pipeline
```
El comando `make pipeline` se encargará automáticamente de generar las instancias, ejecutar todos los algoritmos (con la máxima optimización) y renderizar los gráficos de desempeño requeridos. Para un desglose de los comandos individuales, consulta el README de la carpeta `code/`.
